...
export default function AddPropertyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await propertyApi.add(newProperty);
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-slate-500">Fill in the details below to list your property on Buea Rentals.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            {submitting ? (
              <span className="flex items-center gap-2"><span className="material-symbols-outlined animate-spin text-sm">progress_activity</span> Submitting...</span>
            ) : (
              <span className="flex items-center gap-2"><span className="material-symbols-outlined text-sm">add_home</span> Submit Listing</span>
            )}
          </Button>
        </div>
      </form>
